...
Optional<InstructionStats> LLVMStatisticsPass::analyzeInstructions(Function &f) {
...
static RegisterPass<LLVMStatisticsPass> X("ir-stats", "Print stats about IR", false,
                                   false);
